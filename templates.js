                    ...
                    <tr>
                        <td align="center" bgcolor="#e9ecef">
                            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                                <tr>
                                    <td align="center" bgcolor="#ffffff" style="padding: 36px 24px 0; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; border-top: 3px solid #d4dadf;">
                                        <h1 style="margin: 0; font-size: 32px; font-weight: 700; letter-spacing: -1px; line-height: 48px;">Nos importa su privacidad</h1>
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        <td align="center" bgcolor="#e9ecef">
                            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                                <tr>
                                    <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px; text-align: justify;">
                                        <p style="margin: 0;">Hola ${username}! Hemos recibido su solicitud para actualizar su cuenta. Antes de que empecemos, tenemos que confirmar que eres realmente tú. A continuación, le proporcionamos un código de verificación para confirmar su correo electrónico:</p>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="left" bgcolor="#ffffff">
                                ...
                                <tr>
                                    <td align="left" bgcolor="#ffffff" style="padding: 24px 24px 0px 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px; text-align: justify;">
                                        <p style="margin: 0;">Si no ha solicitado la actualización de su cuenta en ConsulTorIa, puede eliminar este correo electrónico de forma segura.</p>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px; border-bottom: 3px solid #d4dadf">
                    ...
                    <tr>
                        <td align="center" bgcolor="#e9ecef" style="padding: 12px;">
                            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                                <tr>
                                    <td align="center" bgcolor="#e9ecef" style="padding: 12px 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 20px; color: #666;">
                                        <p style="margin: 0;">Recibió este correo electrónico porque recibimos una solicitud para actualizar su cuenta. Si no solicitó la actualización de su cuenta, puede eliminar este correo electrónico de forma segura.</p>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="center" bgcolor="#e9ecef" style="padding: 12px 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 20px; color: #666;">
